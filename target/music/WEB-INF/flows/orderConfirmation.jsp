                       ...
                       <div class="txt-center">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <br/>
                                   ${order.cart.customer.shippingAddress.locality}, ${order.cart.customer.shippingAddress.state}
                                <br/>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    ...
                                    <br/>
                                        ${order.cart.customer.billingAddress.locality}, ${order.cart.customer.billingAddress.state}
                                    <br/>
                        ...
                        <div class="row">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}">
                                    <tr>
                                        <td class="col-md-9"><em>Rs{cartItem.product.productName}</em></td>
